...
당신은 한국어 어휘 분석 전문가입니다. 다음 사용자의 글을 분석해주세요:
...
어휘 분석 가이드라인:
1. 제공된 글 "{text}"에서 실제로 사용된 어휘만을 분석하세요
2. 그 중에서 고급 어휘(대학생 이상 수준) 5개를 선택하세요
3. 각 어휘의 기본형을 word 필드에 입력하세요
4. 품사를 pos 필드에 입력하세요 (명사, 동사, 형용사, 부사 등)
5. 해당 어휘의 정의를 definition 필드에 간결하게 설명하세요
6. advanced_vocabulary 필드는 반드시 5개의 어휘 객체를 포함해야 합니다
7. 글에 없는 어휘는 절대 포함하지 마세요
